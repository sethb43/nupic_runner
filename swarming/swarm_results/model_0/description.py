...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'Trans_Time_timeOfDay': None, u'Trans_Time_weekend': None, u'Cost': {'maxval': 850.0, 'name': 'Cost', 'clipInput': True, 'minval': 0.0, 'n': 272, 'fieldname': 'Cost', 'w': 21, 'type': 'ScalarEncoder'}, u'Trans_Time_dayOfWeek': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
